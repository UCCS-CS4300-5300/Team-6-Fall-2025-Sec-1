        ...
        if form.is_valid():
            ...
            if getattr(settings, "CREATE_JSON_OUTPUT", False):
                export_payload = {
                    ...
                    "wake_up_time": preference.wake_up_time.isoformat() if preference.wake_up_time else None,
                    "sleep_time": preference.sleep_time.isoformat() if preference.sleep_time else None,
                    "enable_meals": preference.enable_meals,
                    "breakfast_time": preference.breakfast_time.isoformat() if preference.breakfast_time else None,
                    "lunch_time": preference.lunch_time.isoformat() if preference.lunch_time else None,
                    "dinner_time": preference.dinner_time.isoformat() if preference.dinner_time else None,
